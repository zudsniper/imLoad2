...
public class ZMisc {
	...
	public static boolean equalsOr(String term,boolean ignoreCase, String... strs) {
		for(String str : strs) {
			if(ignoreCase) {
	...
	public static boolean containsOr(String term,boolean ignoreCase, String... strs) {
		for(String str : strs) {
			if(ignoreCase) {
				return containsIgnoreCase(term,str);
			} else {
	...
	public static boolean containsIgnoreCase(String term, String str) {
